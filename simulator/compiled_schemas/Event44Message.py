...
def AddReferenceTime(builder, referenceTime):
    Event44MessageAddReferenceTime(builder, referenceTime)
...
def AddReferenceTimeIndex(builder, referenceTimeIndex):
    Event44MessageAddReferenceTimeIndex(builder, referenceTimeIndex)
...
def AddTimeOfFlight(builder, timeOfFlight):
    Event44MessageAddTimeOfFlight(builder, timeOfFlight)
...
def AddPixelId(builder, pixelId):
    Event44MessageAddPixelId(builder, pixelId)
