...
def AddName(builder, name):
    SampleEnvironmentDataAddName(builder, name)
...
def AddPacketTimestamp(builder, packetTimestamp):
    SampleEnvironmentDataAddPacketTimestamp(builder, packetTimestamp)
...
def AddTimeDelta(builder, timeDelta):
    SampleEnvironmentDataAddTimeDelta(builder, timeDelta)
...
def AddTimestampLocation(builder, timestampLocation):
    SampleEnvironmentDataAddTimestampLocation(builder, timestampLocation)
...
def AddValuesType(builder, valuesType):
    SampleEnvironmentDataAddValuesType(builder, valuesType)
...
def AddValues(builder, values):
    SampleEnvironmentDataAddValues(builder, values)
...
def AddTimestamps(builder, timestamps):
    SampleEnvironmentDataAddTimestamps(builder, timestamps)
...
def AddMessageCounter(builder, messageCounter):
    SampleEnvironmentDataAddMessageCounter(builder, messageCounter)
