...
def fc00_ConfigUpdateStart(builder):
    builder.StartObject(2)

def Start(builder):
    fc00_ConfigUpdateStart(builder)

def fc00_ConfigUpdateAddConfigChange(builder, configChange):
    builder.PrependUint16Slot(0, configChange, 0)

def AddConfigChange(builder, configChange):
    fc00_ConfigUpdateAddConfigChange(builder, configChange)

def fc00_ConfigUpdateAddStreams(builder, streams):
...
def AddStreams(builder, streams):
    fc00_ConfigUpdateAddStreams(builder, streams)

def fc00_ConfigUpdateStartStreamsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartStreamsVector(builder, numElems):
    return fc00_ConfigUpdateStartStreamsVector(builder, numElems)

def fc00_ConfigUpdateEnd(builder):
