...
class da00_Variable(object):
    ...
    def da00_VariableBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x64\x61\x30\x30", size_prefixed=size_prefixed)
...
def Start(builder):
    da00_VariableStart(builder)

def da00_VariableAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    da00_VariableAddName(builder, name)
...
def AddUnit(builder, unit):
    da00_VariableAddUnit(builder, unit)
...
def AddLabel(builder, label):
    da00_VariableAddLabel(builder, label)
...
def AddSource(builder, source):
    da00_VariableAddSource(builder, source)

def da00_VariableAddDataType(builder, dataType):
    builder.PrependInt8Slot(4, dataType, 0)

def AddDataType(builder, dataType):
    da00_VariableAddDataType(builder, dataType)

def da00_VariableAddAxes(builder, axes):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(axes), 0)

def AddAxes(builder, axes):
    da00_VariableAddAxes(builder, axes)
...
def da00_VariableAddShape(builder, shape):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(shape), 0)

def AddShape(builder, shape):
    da00_VariableAddShape(builder, shape)
...
def AddData(builder, data):
    da00_VariableAddData(builder, data)
