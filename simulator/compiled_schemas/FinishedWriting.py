...
class FinishedWriting(object):
    ...
    @classmethod
    def GetRootAsFinishedWriting(cls, buf, offset=0):
...
def AddServiceId(builder, serviceId):
    FinishedWritingAddServiceId(builder, serviceId)
...
def AddJobId(builder, jobId):
    FinishedWritingAddJobId(builder, jobId)

def FinishedWritingAddErrorEncountered(builder, errorEncountered):
    builder.PrependBoolSlot(2, errorEncountered, 0)

def AddErrorEncountered(builder, errorEncountered):
    FinishedWritingAddErrorEncountered(builder, errorEncountered)
...
def AddFileName(builder, fileName):
    FinishedWritingAddFileName(builder, fileName)
...
def AddMetadata(builder, metadata):
    FinishedWritingAddMetadata(builder, metadata)
...
def AddMessage(builder, message):
    FinishedWritingAddMessage(builder, message)

def FinishedWritingEnd(builder):
    return builder.EndObject()

def End(builder):
    return FinishedWritingEnd(builder)
