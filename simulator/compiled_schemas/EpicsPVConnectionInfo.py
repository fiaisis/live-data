...
def AddSourceName(builder, sourceName):
    EpicsPVConnectionInfoAddSourceName(builder, sourceName)
...
def AddServiceId(builder, serviceId):
    EpicsPVConnectionInfoAddServiceId(builder, serviceId)
