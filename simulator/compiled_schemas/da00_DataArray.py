...
class da00_DataArray(object):
    ...
    def Data(self, j):
        ...
        if o != 0:
            ...
            from da00_Variable import da00_Variable
            obj = da00_Variable()
...
def AddData(builder, data):
    da00_DataArrayAddData(builder, data)
